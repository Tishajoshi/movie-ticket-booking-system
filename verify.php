...
if (isset($_POST['submit'])) {
    ...
    $qry = "INSERT INTO bookingtable(`movieID`, `bookingTheatre`, `bookingType`, `bookingDate`, `bookingTime`, `seats`, `bookingFName`, `bookingLName`, `bookingPNumber`, `bookingEmail`,`amount`, `ORDERID`)VALUES ('$movieid','$theatre','$type','$date','$time','$seats','$fname','$lname','$mobile','$email','Not Paid','$order')";
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="TXN_AMOUNT" value="<?php echo $total; ?>" readonly>
